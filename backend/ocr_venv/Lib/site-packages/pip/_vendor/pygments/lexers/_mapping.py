...
LEXERS = {
    ...
    'ApacheConfLexer': ('pip._vendor.pygments.lexers.config', 'ApacheConf', ('apacheconf', 'aconf', 'apache'), ('.htaccess', 'apache.conf', 'apache2.conf'), ('text/x-apacheconf',)),
    ...
    'AugeasLexer': ('pip._vendor.pygments.lexers.config', 'Augeas', ('augeas',), ('*.aug',), ()),
    ...
    'Cfengine3Lexer': ('pip._vendor.pygments.lexers.config', 'CFEngine3', ('cfengine3', 'cf3'), ('*.cf',), ()),
    ...
    'DockerLexer': ('pip._vendor.pygments.lexers.config', 'Docker', ('docker', 'dockerfile'), ('Dockerfile', '*.docker'), ('text/x-dockerfile-config',)),
    ...
    'IniLexer': ('pip._vendor.pygments.lexers.config', 'INI', ('ini', 'cfg', 'dosini'), ('*.ini', '*.cfg', '*.inf', '.editorconfig', '*.service', '*.socket', '*.device', '*.mount', '*.automount', '*.swap', '*.target', '*.path', '*.timer', '*.slice', '*.scope'), ('text/x-ini', 'text/inf')),
    ...
    'KconfigLexer': ('pip._vendor.pygments.lexers.config', 'Kconfig', ('kconfig', 'menuconfig', 'linux-config', 'kernel-config'), ('Kconfig*', '*Config.in*', 'external.in*', 'standard-modules.in'), ('text/x-kconfig',)),
    ...
    'LighttpdConfLexer': ('pip._vendor.pygments.lexers.config', 'Lighttpd configuration file', ('lighttpd', 'lighty'), ('lighttpd.conf',), ('text/x-lighttpd-conf',)),
    ...
    'NestedTextLexer': ('pip._vendor.pygments.lexers.config', 'NestedText', ('nestedtext', 'nt'), ('*.nt',), ()),
    ...
    'NginxConfLexer': ('pip._vendor.pygments.lexers.config', 'Nginx configuration file', ('nginx',), ('nginx.conf',), ('text/x-nginx-conf',)),
    ...
    'PacmanConfLexer': ('pip._vendor.pygments.lexers.config', 'PacmanConf', ('pacmanconf',), ('pacman.conf',), ()),
    ...
    'PkgConfigLexer': ('pip._vendor.pygments.lexers.config', 'PkgConfig', ('pkgconfig',), ('*.pc',), ()),
    ...
    'PropertiesLexer': ('pip._vendor.pygments.lexers.config', 'Properties', ('properties', 'jproperties'), ('*.properties',), ('text/x-java-properties',)),
    ...
    'RegeditLexer': ('pip._vendor.pygments.lexers.config', 'reg', ('registry',), ('*.reg',), ('text/x-windows-registry',)),
    ...
    'SingularityLexer': ('pip._vendor.pygments.lexers.config', 'Singularity', ('singularity',), ('*.def', 'Singularity'), ()),
    ...
    'SquidConfLexer': ('pip._vendor.pygments.lexers.config', 'SquidConf', ('squidconf', 'squid.conf', 'squid'), ('squid.conf',), ('text/x-squidconf',)),
    ...
    'TOMLLexer': ('pip._vendor.pygments.lexers.config', 'TOML', ('toml',), ('*.toml', 'Pipfile', 'poetry.lock'), ()),
    ...
    'TermcapLexer': ('pip._vendor.pygments.lexers.config', 'Termcap', ('termcap',), ('termcap', 'termcap.src'), ()),
    'TerminfoLexer': ('pip._vendor.pygments.lexers.config', 'Terminfo', ('terminfo',), ('terminfo', 'terminfo.src'), ()),
    'TerraformLexer': ('pip._vendor.pygments.lexers.config', 'Terraform', ('terraform', 'tf'), ('*.tf',), ('application/x-tf', 'application/x-terraform')),
    ...
    'UnixConfigLexer': ('pip._vendor.pygments.lexers.config', 'Unix/Linux config files', ('unixconfig', 'linuxconfig'), (), ()),
